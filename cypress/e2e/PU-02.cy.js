describe('PU-02: ', () => {
    it('Deberia fallar si el campo nombre no acepta espacios (Reporte de Error)', () => {
        ...
        cy.get('#contenido-principal #nuevoNombre').clear().type('Testeo de Hasheo');
        cy.get('#contenido-principal #nuevoApellidoP').clear().type('Tester');
        cy.get('#contenido-principal #nuevoApellidoM').clear().type('Tester');
