describe('PS-01: Validación de información', () => {
    it('Podria fallar si no es correcto la información o el guardado', () => {
        ...
        cy.get('#contenido-principal #editarNombreDispositivo').clear().type('LabD1HPEssential-2');
        cy.get('#contenido-principal #editarNumeroInventario').clear().type('55109288965');
        cy.get('#contenido-principal #selectModelos').select('9');
