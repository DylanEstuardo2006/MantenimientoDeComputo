describe('PI-01: Validación de información', () => {
    it('Podria fallar si no es correcto la información o el guardado', () => {
        ...
        cy.get('#contenido-principal #editarNombreDispositivo').clear().type('LabD1HPEssential-1');
        cy.get('#contenido-principal #editarNumeroInventario').clear().type('55109283273');
