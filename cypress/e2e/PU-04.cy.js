describe('PU-04: Validación de información del formulario Usuarios', () => {
    it('Deberia fallar si el campo nombre no acepta espacios (Reporte de Error)', () => {
        ...
        cy.get('#contenido-principal #nuevoNombre').clear().type('Dylan Estuardo');
        cy.get('#contenido-principal #nuevoApellidoP').clear().type('Flores');
        cy.get('#contenido-principal #nuevoApellidoM').clear().type('Sagahón');
        cy.get('#contenido-principal #nuevaMatricula').clear().type('77777777');
