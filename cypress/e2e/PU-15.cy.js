describe('PU-15: Registro de Orden de Trabajo y comprobación de Información.', () => {
    it('Debería registrar una orden de trabajo y mostrar la información correctamente', () => {
        // 1. Inicio de Sesión
